...
STACK_FILES = {
    ...
    "scripts/auto_reducer_watcher.py": SUPPORT / "scripts" / "auto_reducer_watcher.py",
    "scripts/build_skill_index.py": SUPPORT / "scripts" / "build_skill_index.py",
    "scripts/skill_index.py": SUPPORT / "scripts" / "skill_index.py",
    "scripts/skill_trigger.py": SUPPORT / "scripts" / "skill_trigger.py",
    ...
    "scripts/llm_wiki_skills.ps1": SUPPORT / "scripts" / "llm_wiki_skills.ps1",
    "scripts/llm_wiki_skills.cmd": SUPPORT / "scripts" / "llm_wiki_skills.cmd",
...
BOOTSTRAP_FILES = {
    ...
    "scripts/.gitkeep": "",
    ".llm-wiki/.gitkeep": "",
    ".llm-wiki/.gitignore": "node_modules/\npackage-lock.json\ntools/\nsetup-state.json\nskill-pipeline/runs/*\n!skill-pipeline/runs/.gitkeep\nmemory-ledger/candidates/*\n!memory-ledger/candidates/.gitkeep\nmemory-ledger/approved/*\n!memory-ledger/approved/.gitkeep\nmemory-ledger/events.jsonl\nmemory-ledger/index.json\n",
    ...
    ".llm-wiki/memory-ledger/.gitkeep": "",
    ".llm-wiki/memory-ledger/candidates/.gitkeep": "",
    ".llm-wiki/memory-ledger/approved/.gitkeep": "",
    ".brv/.gitkeep": "",
...
def build_stack_config(args: argparse.Namespace) -> dict[str, object]:
    ...
    return {
        ...
        "memory_controller": {
            "script_path": "scripts/llm_wiki_memory_controller.py",
            "ledger_path": ".llm-wiki/memory-ledger",
            "generated_wiki_path": "wiki/syntheses/memory-ledger-approved.md",
            "review_gate": True,
            "min_confidence": "low",
            "ranking": {
                "lexical_weight": 0.7,
        ...
        "gitvizz": {
            ...
            "repo_id": "",
            "authorization_env": "LLM_WIKI_GITVIZZ_AUTHORIZATION",
            "auth_token_env": "LLM_WIKI_GITVIZZ_TOKEN",
            "auth_scheme": "Bearer",
...
def packet_required_paths(vault: Path) -> list[Path]:
    return [
        ...
        vault / "scripts" / "auto_reducer_watcher.py",
        vault / "scripts" / "build_skill_index.py",
        vault / "scripts" / "skill_index.py",
        vault / "scripts" / "skill_trigger.py",
        ...
        vault / "scripts" / "llm_wiki_skills.ps1",
